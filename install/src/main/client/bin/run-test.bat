...
set SPRINGBOOT_OPTIONS=--logging.file=%USERPROFILE%\var\log\sysmon\%SYSMON_MODULE%.log --spring.application.name="TEST - DCOM Deployment Manager"

set SYSMON_OPTIONS=--sysmon.server.url=https://st1mons11.test.dcom.sk
